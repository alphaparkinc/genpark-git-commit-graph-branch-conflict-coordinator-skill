# genpark-git-commit-graph-branch-conflict-coordinator-skill
...
> **GenPark AI Agent Skill** -- Multi-agent git commit graph visualizer & branch conflict coordinator (GitLens style)
